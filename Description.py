...
for index, row in pdf_data.iterrows():
    ...
    prompt = f"What happened, short description. Limit 100 words:\n\n{pdf_text}"
...
output_csv_path = r'C:\Users\rsun2\OneDrive\Description.csv'

# Save the results to the new CSV file
results_df.to_csv(output_csv_path, index=False)

print("Process completed and results saved to Description.csv.")
