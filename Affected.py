...
for index, row in pdf_data.iterrows():
    ...
    prompt = f"Just give me the integer number of individuals affected if the number of individuals affected is unknown write n/a:\n\n{pdf_text}"
...
output_csv_path = r'C:\Users\rsun2\OneDrive\Affected_data.csv'

# Save the results to the new CSV file
results_df.to_csv(output_csv_path, index=False)

print("Process completed and results saved to Affected_data.csv.")
